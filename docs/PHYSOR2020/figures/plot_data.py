...
if plot_RM:
    ''' Upload one file '''
    path_RM_flx_file1 = "../../../FD1dMGdiff/output/kflx_MC2011_LBC0RBC0_pCMFD_I100_ritr100.npy"
    path_RM_flx_file2 = "../../../FD1dMGdiff/output/kflx_MC2011_LBC0RBC0_CMFD_I100_ritr100.npy"
...
if plot_SN:
    ...
    path_SN_flx_file = "../../../SNMG1DSlab/output/kflx_MC2011_LBC0RBC0_I100_L21_N16.npy"
    ref_data = np.load(path_SN_flx_file,allow_pickle=True)
    k_SN, flxm = ref_data[0], ref_data[1]
...
# ====================================================== #
if Plot_flx_cvg:
    J = [1,2,5,10,25,50,-1] # No. of itr to plot
    ...
    for j in range (0,np.size(J)):
        dev_flx[:,:,j] = (flx_RM2[:,:,J[j]] - flx_SN[:,0,:]) / flx_SN[:,0,:] *100
    ...
    fig.savefig('MC2011_LBC0RBC0_I%d_itr%d.pdf' %(I,itr),dpi=150,bbox_inches='tight')
