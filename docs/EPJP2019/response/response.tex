...
\\ \\
\revised{Indeed, the Ronen method is highly suited for non-homogeneous systems. An entire benchmark was added to the results section. The chosen benchmark is a one-dimensional highly heterogeneous core representing a BWR core. As nicely pointed out by the reviewer, the new figures 11-13 in the revised manuscript demonstrate the natural capability of the Ronen method to deal with material interfaces and strong flux gradients.}
