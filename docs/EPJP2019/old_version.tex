...
%The growing demand for high-accuracy and high-precision full-core computations challenges not only today’s high-end computing systems but will also challenge the near future (e.g., Exascale) computers~\cite{Martin-2012,Smith-2011,Kim-2019}.  
...
\end{split}
\end{equation}
% commented to overcome an error of latexdiff
...
\end{equation}
% commented to avoid an error by latexdiff
